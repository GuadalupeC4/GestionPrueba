...
public partial class GestionPContext2 : DbContext
{
    public GestionPContext2()
    {
    }

    public GestionPContext2(DbContextOptions<GestionPContext> options)
        : base(options)
    {
    }
    ...
    public GestionPContext2(string valor)
    {
        Conexion = valor;
    }
}
